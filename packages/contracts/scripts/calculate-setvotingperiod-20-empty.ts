...
async function main() {
    console.log("🔢 Calculating Proposal to Set Voting Period to 20 (Empty Description)...\n");

    const GOVERNOR_ADDRESS = "0xe43912445ABcE9204e2cc774d29e4B9D6F58f09e";
    const newVotingPeriod = 20; // New voting period in blocks
    ...
    const description = ""; // EMPTY description as requested
    ...
    console.log("\n📝 Summary:");
    console.log(`   This proposal will call setVotingPeriod(${newVotingPeriod}) on the Governor contract.`);
    console.log(`   After execution, the voting period will change to ${newVotingPeriod} blocks.`);
